...
def index(request):
    ...
    brands = get_brands()
    orders=get_orders()
    smartphones = get_smartphones(selected_brand, max_price,sort)
    ...
    return render(request, 'index.html', {
        ...
        'orders':orders,
        'search':{'brand':selected_brand,'max':max_price,'length':length}
    })




def get_smartphones(selected_brand,max_price,sort):
    URL = f"https://www.jumia.com.tn/smartphones/{selected_brand}/?sort={sort}-{max_price}"
